...
SELECT 'admin@mealsync.com', '$2a$10$ZjXzGXkNTL5u.rcKGYC9N.cQoVYfV.kX4.nFEj0EONvK3O9F5YgYi', 'admin'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@mealsync.com');

INSERT INTO users (email, password, role)
SELECT 'employee1@mealsync.com', '$2a$10$ZjXzGXkNTL5u.rcKGYC9N.cQoVYfV.kX4.nFEj0EONvK3O9F5YgYi', 'employee'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'employee1@mealsync.com');

INSERT INTO users (email, password, role)
SELECT 'employee2@mealsync.com', '$2a$10$ZjXzGXkNTL5u.rcKGYC9N.cQoVYfV.kX4.nFEj0EONvK3O9F5YgYi', 'employee'
