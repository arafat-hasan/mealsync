...
DROP TRIGGER IF EXISTS trg_validate_menu_item_comment ON menu_item_comment;
DROP TRIGGER IF EXISTS trg_rating_insert ON menu_item_comment;
DROP TRIGGER IF EXISTS trg_rating_update ON menu_item_comment;
